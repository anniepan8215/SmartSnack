...
if __name__ == '__main__':
    ...
    while True:
        ...
        if game_over is True:
            actions_collect = actions_collect[-2:] if len(actions_collect) >= 2 else actions_collect
            data_list = data_list + actions_collect
            score = new_score
            new_score = 0
            actions_collect = []
        ...
        # if len(actions_collect) > 7 and action != [1,0,0]:
